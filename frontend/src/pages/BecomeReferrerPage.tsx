            ...
            <div className="max-w-2xl mx-auto mb-12">
              ...
              >
                <div className="text-center mb-8">
                  <Building2 className="h-12 w-12 mx-auto mb-4 text-brand-purple" />
                  <h2 className="font-display text-3xl font-bold text-gray-900 mb-2">Sign Up as Referrer</h2>
                  <p className="text-gray-600">Use your organization email to get started</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-purple focus:border-transparent"
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">Must be a company email (not Gmail, Yahoo, etc.)</p>
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-gradient-primary text-white py-4 rounded-lg font-semibold hover:shadow-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                  ...
                  <p className="text-center text-sm text-gray-600">
                    ...
                    <Link to="/referrer-login" className="font-medium text-brand-purple hover:text-brand-magenta transition-colors">
                      Sign in
                    </Link>
                  </p>
                </form>
